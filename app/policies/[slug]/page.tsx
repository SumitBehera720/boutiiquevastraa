...
export default async function PolicyPage({ params }: any) {
  ...
  const formattedWhatsapp = whatsappNumber.replace(/^91/, "").replace(/(\d{5})(\d{5})/, "$1 $2");
  ...
  const policies: Record<string, { title: string; content: string[] }> = {
    "privacy-policy": {
      ...
      content: [
        ...
        "If you have any questions or feedback regarding this privacy policy, please contact us at " + email + "."
      ]
    },
    "terms-conditions": {
      ...
      content: [
        ...
        "If you have any queries about our terms, please reach out to our legal department at " + email + "."
      ]
    },
    "refund-policy": {
      title: "Refund Policy",
      content: [
        ...
        "If you have any questions or require support, please contact us at " + email + "."
      ]
    },
    "shipping-policy": {
      ...
      content: [
        ...
        "If you experience any delivery delays or need courier help, reach out to us at " + email + "."
      ]
    },
    "return-policy": {
      title: "Return Policy",
      content: [
        ...
        "For return requests or support, contact our returns team at " + email + " or WhatsApp us at +91 - " + formattedWhatsapp + "."
      ]
    }
  };
