  ...
  return (
    <header className="bg-[#EBE2CD] w-full">
      ...
      <div className="bg-[#FFFDF9] flex items-center justify-between gap-4 px-2 py-2 sm:px-4 md:px-6">
        {/* Left: Secondary Logo & Social Icons */}
        <div className="flex flex-1 items-center gap-3">
          <Link href="/" className="bg-transparent block h-10 sm:h-12 w-auto max-w-[140px] sm:max-w-[200px] md:max-w-[220px] relative shrink-0 transition-opacity hover:opacity-90">
            <Image
              alt="Boutiique Vastraa Secondary Logo"
              width={220}
              height={50}
              className="object-contain h-10 sm:h-12 w-auto"
              src="/images/ChatGPT Image Aug 31, 2026, 01_46_03 PM.png"
              priority
            />
          </Link>

          <div className="flex items-center max-md:hidden gap-2 border-l border-amber-900/10 pl-3">
